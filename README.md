...
- [gazebo-yarp-plugins (forked)](https://github.com/xEnVrE/gazebo-yarp-plugins/tree/visual_tactile_loc_plugins) including:
  ...
  - `GazeboYarpControlBoard` (with joint velocity control reimplemented and [wrong joint limits of fingers](https://github.com/robotology/gazebo-yarp-plugins/issues/348) fixed)
